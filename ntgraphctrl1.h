...
/////////////////////////////////////////////////////////////////////////////
// CNtgraphctrl1 wrapper class

class CNtgraphctrl1 : public CWnd
{
protected:
	DECLARE_DYNCREATE(CNtgraphctrl1)
public:
...
double get_ElementXValue(long index, short ElementID)
{
	...
	InvokeHelper(0x4a, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, parms, index, ElementID);
	return result;
}
void put_ElementXValue(long index, short ElementID, double newValue)
{
	static BYTE parms[] = VTS_I4 VTS_I2 VTS_R8 ;
	InvokeHelper(0x4a, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, index, ElementID, newValue);
}
double get_ElementYValue(long index, short ElementID)
{
	double result;
	static BYTE parms[] = VTS_I4 VTS_I2 ;
	InvokeHelper(0x4b, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, parms, index, ElementID);
	return result;
}
void put_ElementYValue(long index, short ElementID, double newValue)
{
	static BYTE parms[] = VTS_I4 VTS_I2 VTS_R8 ;
	InvokeHelper(0x4b, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, index, ElementID, newValue);
}
...
void PlotY(std::vector <double> *x, std::vector <double> *y, short ElementID)
{
	static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_I2 ;
	InvokeHelper(0x3d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, x, y, ElementID);
}
void ShowProperties()
{
