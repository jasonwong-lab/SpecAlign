...
#define HID_FILE_IMPORT                         0x10084
#define HID_IMPORT_FILE                         0x10085
#define HID_IMPORT_FOLDER                       0x10086
#define HID_FILE_EXPORT                         0x10087
#define HID_EXPORT_FILE                         0x10088
#define HID_Menu                                0x10089
#define HID_PROCESSING_NORMALIZETIC             0x1008A
#define HID_PROCESSING_RELATIVEINTENSITIES      0x1008B
#define HID_EDIT_REVERT                         0x1008C
#define HID_VIEW_AVERAGESPEC                    0x1008D
#define HID_GRAPH_ZOOM                          0x1008E
#define HID_GRAPH_TRACK                         0x1008F
#define HID_GRAPH_RESET                         0x10090
#define HID_GRAPH_CURSOR                        0x10091
#define HID_EDIT_UNDOZOOM                       0x10092
#define HID_EDIT_REVERTALLZOOM                  0x10094
#define HID_SPECTRUM_VIEWAS                     0x10095
#define HID_VIEWAS_LINEGRAPH                    0x10096
#define HID_VIEWAS_BARGRAPH                     0x10097
#define HID_SPECTRUM_PICKPEAKS                  0x10098
#define HID_SPECTRUM_SHOWPEAKS                  0x1009C
#define HID_SPECTRUM_REMOVEPEAKS                0x1009D
#define HID_PROCESSING_ALIGNPEAKS               0x1009E
#define HID_SPECTRUM_PLOTPEAKS                  0x100A0
#define HID_EXPORT_MULTIFILE                    0x100A3
#define HID_SPECTRUM_CROP                       0x100A4
#define HID_SPECTRUM_REMOVESPECTRUM             0x100A5
#define HID_PROCESSINGBINS                      0x100A8
#define HID_PROCESSING_SMOOTH                   0x100B0
#define HID_SPECTRUM_GENERATEAVERAGESPECTRUM    0x100B2
#define HID_Menu179                             0x100B3
#define HID_SPECTRUM_MERGEWITHAVERAGESPECTRUM   0x100B4
#define HID_IMPORT_AVERAGESPECTRUM              0x100B5
#define HID_EXPORT_AVERAGESPECTRUM              0x100B6
#define HID_VIEWAS_STACKEDGRAPH                 0x100B9
#define HID_PROCESSING_SCALE                    0x100BA
#define HID_PROCESSING_SUBTRACTBASELINE         0x100BC
#define HID_SPECTRUM_MANUALPICKPEAKS            0x100BE
#define HID_SPECTRUM_AUTOSCALE                  0x100C0
#define HID_SPECTRUM_MANUALREMOVEPEAKS          0x100C2
#define HID_SPECTRUM_CROPFROM                   0x100C4
#define HID_VIEWAS_OVERLAPPINGGRAPH             0x100C6
#define HID_PROCESSING_RESCALETOPOSITIVE        0x100C7
#define HID_PROCESSING_REMOVENEGATIVE           0x100C8
#define HID_TOOLS_COMBINESPECTRA                0x100C9
#define HID_TOOLS_SUBTRACTSPECTRA               0x100CA
#define HID_TOOLS_COMPARESPECTRA                0x100CD
#define HID_TOOLS_COMPAREALL                    0x100D0
#define HID_PROCESSING_SPECTRAALIGNMENTBYBESTFIT	0x100D1
#define HID_PROCESSING_SPECTRAALIGNMENT         0x100D3
#define HID_SPECTRAALIGNMENT_COMBINEDMETHOD     0x100D4
#define HID_SPECTRAALIGNMENT_CHOICE             0x100D7
#define HID_VIEW_FASTDRAW                       0x100D8
#define HID_TOOLS_GENERATECORRELELOGRAPH        0x100D9
#define HID_SPECTRAALIGNMENT_FFTMETHOD          0x100DB
#define HID_EXPORT_PEAKS                        0x100DD
#define HID_BUTTON32807                         0x18027
#define HID_VIEW_BASELINE                       0x18029
#define HID_SPECTRUM_CALCULATEPEAKAREAS         0x1802B
#define HID_EXPORT_PEAKAREA                     0x1802D
#define HID_PROCESSING_DENOISE                  0x1802E
#define HID_TOOLS_EVALUATEDATASET               0x18031
#define HID_EXPORT_SPECTRAMODEL                 0x18032
...
#define HIDR_SpecAlignTYPE                      0x20081
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_DIALOG1                            0x20082
#define HIDD_DIALOG2                            0x20099
#define HIDD_DIALOG3                            0x2009F
#define HIDD_DIALOG5                            0x200A6
#define HIDD_DIALOG6                            0x200A7
#define HIDD_DIALOG7                            0x200A9
#define HIDD_DIALOG8                            0x200B1
#define HIDD_DIALOG9                            0x200B7
#define HIDD_DIALOG10                           0x200BB
#define HIDD_DIALOG11                           0x200BD
#define HIDD_DIALOG4                            0x200C1
#define HIDD_DIALOG12                           0x200C5
#define HIDD_DIALOG13                           0x200CB
#define HIDD_DIALOG14                           0x200CC
#define HIDD_DIALOG15                           0x200CE
#define HIDD_DIALOG16                           0x200CF
#define HIDD_DIALOG17                           0x200D2
#define HIDD_DIALOG18                           0x200D5
#define HIDD_DIALOG19                           0x200D6
#define HIDD_DIALOG20                           0x200DA
#define HIDD_DIALOG21                           0x200DC
#define HIDD_DIALOG22                           0x200DF
#define HIDD_DIALOG23                           0x200E0
#define HIDD_DIALOG24                           0x200E1
#define HIDD_DIALOG25                           0x200E4
#define HIDD_DIALOG26                           0x200E5
